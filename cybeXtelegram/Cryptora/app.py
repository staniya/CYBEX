...
def inlinequery(bot, update):
        ...
        try:
            ...
            results = [
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent("$" +
                                                                  str(inputDollarValue) + " = " +
                                                                  str(value.calculatedValue) + " " +
                                                                  str(inputCoin.symbol)))
            ]
        except:
    ...
    elif dateInString is True or "ago" in query or "yesterday" in query:
        ...
        results = [
            ...
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(str(data.activeCryptoCount)
                                                              + " active cryptocurrencies on CoinMarketCap.",
                                                              ParseMode.MARKDOWN)),
        ...
        results = [
            ...
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent("Need more up-to-the-minute "
                                                              ...
                                                              + "`gdax` to get the prices in-line.",
                                                              ParseMode.MARKDOWN)),
        ...
        if "," in query:
            ...
            results = [
                ...
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent("24 Hour Change in " + coin.name + " (" +
                                                                  coin.symbol + ")" + " Price: " + coin.percentChange
                                                                  + "%"))
            ]
