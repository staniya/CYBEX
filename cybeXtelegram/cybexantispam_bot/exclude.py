...
from exclude_real import create_bot
...
/stat - display simple statistics about number of deleted messages excluding links
/stat_link - display simple statistics about number of deleted links
...
def main():
    ...
    dispatcher.add_handler(CommandHandler('stat_link', handle_stat_link))
